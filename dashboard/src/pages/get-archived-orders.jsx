...
function ArchivedOrders() {
    ...
    useEffect(() => {
        setIsLoad(false);
        axios(`${API_LINK}/boss/get-archived-orders/${page}`, {
            headers: {
    ...
    return (
        <div className="flex items-start justify-start flex-col w-full overflow-x-scroll">
            <div className="flex items-center justify-center w-full h-[50px] mb-[20px]">
                <h1 className="flex items-center justify-center w-[170px] h-[50px] bg-white shadow-sm rounded-b-[10px]">ARXIVLANGANLAR</h1>
            </div>
