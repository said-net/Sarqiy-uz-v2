            ...
            <div className="flex items-center justify-normal flex-col p-[5px] ">
                ...
                <div className="flex items-center justify-between w-full h-[70px] shadow-sm bg-white  border-b p-[0_5px]">
                    <div className="flex items-center justify-between">
                        ...
                        <p className="w-[150px] text-center border-x h-[70px] flex items-center justify-center text-[13px]">OPERATOR</p>
                        <p className="w-[150px] text-center border-x h-[70px] flex items-center justify-center text-[13px]">OPERATOR RAQAMI</p>
