    ...
    return (
        <div className="flex items-start justify-start flex-col w-full overflow-scroll p-[50px_10px]">
            ...
            <div className="flex items-center justify-center border border-gray-500">
                ...
                {/*  */}
                <p className="w-[140px] h-[50px] flex items-center justify-center border-r border-gray-500 text-center text-[11px]">MAHSULOT</p>
                {/*  */}
                <p className="w-[85px] h-[50px] flex items-center justify-center border-r border-gray-500 text-center text-[11px]">NOMI</p>
                {/*  */}
                ...
                {/*  */}
                <p className="w-[85px] h-[50px] flex items-center justify-center border-r border-gray-500 text-center text-[11px]">ARXIV</p>
                {/*  */}
                ...
                {/*  */}
                <p className="w-[100px] h-[50px] flex items-center justify-center border-r border-gray-500 text-center text-[11px]">YETKAZILGAN</p>
                {/*  */}
            ...
            {flows[0] && flows?.map((f, i) => {
                return (
                    <div key={i} onClick={() => setSelect(String(f?.id))} className={`flex items-center justify-center border border-gray-500 border-t-0 ${select === String(f?.id) && 'bg-gray-300'} cursor-pointer`}>
                        {/*  */}
                        ...
                        {/*  */}
                        <p className="w-[140px] h-[50px] flex items-center justify-center border-r border-gray-500 text-center text-[11px]">
                            {f?.product}
                        </p>
                        {/*  */}
